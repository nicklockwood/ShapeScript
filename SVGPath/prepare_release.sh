...
# Add new version entry at the top after the header
{
    echo "# Change Log"
    echo ""
    echo "## [$NEW_VERSION](https://github.com/nicklockwood/SVGPath/releases/tag/$NEW_VERSION) ($CURRENT_DATE)"
    echo ""
    echo "- TODO"
    echo ""
...
# 4. Update version in SVGPath.xcodeproj
echo "Updating SVGPath.xcodeproj..."
sed -i '' "s/MARKETING_VERSION = [^;]*/MARKETING_VERSION = $NEW_VERSION/" SVGPath.xcodeproj/project.pbxproj
...
echo "   - Commit to main and tag release"
echo "   - Push to https://github.com/nicklockwood/SVGPath"
echo ""
