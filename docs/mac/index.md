...
- Geometry
    ...
    - [Meshes](meshes.md)
        ...
        - [Mesh Hierarchies](meshes.md#mesh-hierarchies)
    - [Paths](paths.md)
...
- Syntax
    ...
    - [Control Flow](control-flow.md)
        ...
        - [Control-Flow Expressions](control-flow.md#control-flow-expressions)
    - [Blocks](blocks.md)
    ...
    - [Import](import.md)
        ...
        - [Textures and Fonts](import.md#textures-and-fonts)
...
- [Export](export.md)
    ...
    - [Command-Line Export](export.md#command-line-export)
...
- [Examples](examples.md)
    ...
    - [Cog](examples.md#cog)
    - [Dodecahedron](examples.md#dodecahedron)
    - [Fillet](examples.md#fillet)
    - [Earth](examples.md#earth)
    - [Platonic Solids](examples.md#platonic-solids)
