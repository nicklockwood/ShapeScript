...
ShapeScript follows a variant of [Semantic Versioning](http://semver.org/spec/v2.0.0.html) (semver). 1.0.x releases are for bug fixes and purely additive features, 1.x.0 releases are for breaking changes (under normal semver rules, x.0.0 would be used for breaking changes).
